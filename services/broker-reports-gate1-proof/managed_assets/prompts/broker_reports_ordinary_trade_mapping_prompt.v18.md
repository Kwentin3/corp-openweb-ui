...
Do not infer it from a generic sale, quantities, balances, sequence, layout,
or nearby text. Never emit another effect value. If the exact side literal does
not itself establish opening short, omit position_effect.
