...
TABLE_GATE2_PACKAGE_SCHEMA_VERSION = "broker_reports_source_fact_package_v0"
...
class Gate2TablePackageBuilder:
    ...
    def build(
        ...
        *,
        ...
        source_unit = {
            "unit_id": "tableunit_"
            + stable_digest([package_id, projection.get("table_projection_id")], length=24),
        ...
        package = {
            "schema_version": TABLE_GATE2_PACKAGE_SCHEMA_VERSION,
            ...
            "allowed_evidence_refs": sorted(
                {
                    ...
                    *_strings(_object(projection.get("coverage")).get("fallback_text_refs")),
                }
                - {None, ""}
            ),
...
def validate_gate2_table_package(
    ...
    if package.get("schema_version") != TABLE_GATE2_PACKAGE_SCHEMA_VERSION:
