...
SEMANTIC_REVIEW_PROMPT_VERSION = "ordinary_trade_semantic_review_prompt_v2"
FACTORY_REQUIRED = (
...
class OrdinaryTradeSemanticMapping:
    ...
    def semantic_review_prompt(self) -> Gate2ManagedPrompt:
        content = (
            ...
            "fees, taxes, income, trades or cash activity. Do not infer aggregation merely "
            "from missing fields: a dividend row tied to a security and payment date, or "
            "a trade row with operation, quantity, price and amount, remains financial "
            "content even when other roles are absent. Any independent, incomplete or "
            "damaged financial event remains unsafe to discard. "
