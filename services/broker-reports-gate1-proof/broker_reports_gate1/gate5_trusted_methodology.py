...
_GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_VERSION = "2026.3-experimental"
_GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_RESOURCE = (
    "gate5_tax_methodology.ru_3ndfl_2025_income_group_settlement.v0.json"
)
_GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_RESOURCE_SHA256 = (
    "aa72892a061428ca622066e6b4ef222ba4f9e325cd6fbe2bc92da40a50c49a79"
)
_GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_SCHEMA_VERSION = (
...
GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_VERSION = (
    "2026.6-interpretation-contract"
)
GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_RESOURCE = (
    "gate5_tax_methodology."
    "ru_ndfl_securities_real_source_fact_contract.v1.json"
)
GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_RESOURCE_SHA256 = (
    "360cf24aae51c039fcb67fc9470d7978208bd80961a6de0d85561366d868c281"
)
_GATE5_SOURCE_FACT_CONSUMPTION_LEGACY_VERSION = "2026.5-experimental"
_GATE5_SOURCE_FACT_CONSUMPTION_LEGACY_RESOURCE = (
    "gate5_tax_methodology."
    "ru_ndfl_securities_real_source_fact_contract.v0.json"
)
_GATE5_SOURCE_FACT_CONSUMPTION_LEGACY_RESOURCE_SHA256 = (
    "06947c90e1a24ff7ec62f893eff582e9de4e637a6173bd1a4b027eb783045091"
)
_GATE5_SOURCE_FACT_CONSUMPTION_EARLY_LEGACY_VERSION = "2026.4-experimental"
_GATE5_SOURCE_FACT_CONSUMPTION_EARLY_LEGACY_RESOURCE = (
    "gate5_tax_methodology."
    "ru_ndfl_securities_source_fact_consumption_proof.v0.json"
)
_GATE5_SOURCE_FACT_CONSUMPTION_EARLY_LEGACY_RESOURCE_SHA256 = (
...
_PUBLISHED_METHODOLOGIES = {
    ...
    (
        GATE5_INCOME_GROUP_TAX_SETTLEMENT_METHODOLOGY_ID,
        _GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_VERSION,
    ): _PublishedMethodologyResource(
        resource_name=_GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_RESOURCE,
        resource_sha256=(
            _GATE5_INCOME_GROUP_TAX_SETTLEMENT_LEGACY_RESOURCE_SHA256
        ),
        schema_version=(
    ...
    (
        GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_ID,
        _GATE5_SOURCE_FACT_CONSUMPTION_EARLY_LEGACY_VERSION,
    ): _PublishedMethodologyResource(
        resource_name=_GATE5_SOURCE_FACT_CONSUMPTION_EARLY_LEGACY_RESOURCE,
        resource_sha256=(
            _GATE5_SOURCE_FACT_CONSUMPTION_EARLY_LEGACY_RESOURCE_SHA256
        ),
    ...
    (
        GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_ID,
        _GATE5_SOURCE_FACT_CONSUMPTION_LEGACY_VERSION,
    ): _PublishedMethodologyResource(
        resource_name=_GATE5_SOURCE_FACT_CONSUMPTION_LEGACY_RESOURCE,
        resource_sha256=_GATE5_SOURCE_FACT_CONSUMPTION_LEGACY_RESOURCE_SHA256,
        schema_version=GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_SCHEMA_VERSION,
    ),
    (
        GATE5_SOURCE_FACT_CONSUMPTION_METHODOLOGY_ID,
