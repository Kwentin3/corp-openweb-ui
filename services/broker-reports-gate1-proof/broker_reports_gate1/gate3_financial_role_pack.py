...
GATE3_ROLE_PACK_V4_VERSION = "4.0.0"
GATE3_ROLE_PACK_V4_RESOURCE = "gate3_financial_role_pack.v4.json"
GATE3_ROLE_PACK_V4_FILE_SHA256 = (
    "4d764422e05b7fed09eb36256d830b574a65d7d059eff3e3bf4630b198d1abce"
)
...
_PUBLISHED_VERSIONS = {
    ...
    GATE3_ROLE_PACK_V4_VERSION: _PublishedRolePackResource(
        resource_name=GATE3_ROLE_PACK_V4_RESOURCE,
        file_sha256=GATE3_ROLE_PACK_V4_FILE_SHA256,
    ),
}
...
_DICTIONARY_VERSION_BY_ROLE_PACK_VERSION = {
    ...
    GATE3_ROLE_PACK_V4_VERSION: "2.1.0",
}
