...
class PdfPlumberLayoutAdapter:
    ...
    def parse(
        ...
        *,
        ...
        elif {"candidate", "rejected"} <= table_statuses:
            table_status = "candidate_with_rejections"
        ...
        return PdfLayoutParseResult(
            ...
            diagnostics={
                ...
                "table_terminal_counts": {
                    "candidate_pages_total": sum(
                        page.get("table_candidate_status") == "candidate"
                        for page in pages
                    ),
                    "rejected_pages_total": sum(
                    ...
                    "none_detected_pages_total": sum(
                        page.get("table_candidate_status") == "none_detected"
                        for page in pages
                    ),
                },
                "chars_total": sum(
