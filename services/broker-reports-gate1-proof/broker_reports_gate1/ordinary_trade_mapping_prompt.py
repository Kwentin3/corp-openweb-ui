...
# V21 changes only the managed header-choice instruction.  It retains the
# V20 compact response and its strict source-bound semantic validator.
ORDINARY_TRADE_MAPPING_V21_PROMPT_COMMAND = (
    "broker_ordinary_trade_semantic_mapping_v21"
)
ORDINARY_TRADE_MAPPING_V21_PROMPT_TEMPLATE_ID = (
    "broker_reports.ordinary_trade_semantic_mapping.v21"
)
ORDINARY_TRADE_MAPPING_V21_PROMPT_TEMPLATE_KIND = (
    "broker_reports_ordinary_trade_semantic_mapping"
)
ORDINARY_TRADE_MAPPING_V21_PROMPT_REQUIRED_TAG = (
    "broker-reports-ordinary-trade-mapping-v21"
)
ORDINARY_TRADE_MAPPING_V21_COMPACT_RESPONSE_SCHEMA_VERSION = (
    ORDINARY_TRADE_GROUPED_MAPPING_V20_RESPONSE_SCHEMA_VERSION
)
# V22 changes only the managed amount/currency instruction.  It retains the
# V21 header-choice route and the V20 compact response/validator, while making
# the three consumer-relevant monetary bindings explicit.
ORDINARY_TRADE_MAPPING_V22_PROMPT_COMMAND = (
    "broker_ordinary_trade_semantic_mapping_v22"
)
ORDINARY_TRADE_MAPPING_V22_PROMPT_TEMPLATE_ID = (
    "broker_reports.ordinary_trade_semantic_mapping.v22"
)
ORDINARY_TRADE_MAPPING_V22_PROMPT_TEMPLATE_KIND = (
    "broker_reports_ordinary_trade_semantic_mapping"
)
ORDINARY_TRADE_MAPPING_V22_PROMPT_REQUIRED_TAG = (
    "broker-reports-ordinary-trade-mapping-v22"
)
...
_ACCEPTED_PROMPT_SNAPSHOT_IDENTITIES = (
    ...
    {
        "commands": frozenset({ORDINARY_TRADE_MAPPING_V21_PROMPT_COMMAND}),
    ...
    {
        "commands": frozenset({ORDINARY_TRADE_MAPPING_V22_PROMPT_COMMAND}),
