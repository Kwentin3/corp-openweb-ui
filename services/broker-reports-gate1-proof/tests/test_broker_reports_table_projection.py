...
from tests import test_broker_reports_gate1_backend_contract as _backend_contract
...
class BrokerReportsTableProjectionTest(unittest.TestCase):
    ...
    def test_factory_anchors_and_native_csv_html_xlsx_projection(self):
        ...
        xlsx = (
            _backend_contract.BrokerReportsGate1BackendContractTest()
            ._synthetic_xlsx_bytes()
        )
        result = Gate1Normalizer().normalize(
            [
                FileInput.from_bytes(
    ...
    def test_gate2_native_packages_route_segment_and_do_not_mutate_store(self):
        result = Gate1Normalizer().normalize(
            [
                FileInput.from_bytes(
