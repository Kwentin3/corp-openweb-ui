    ...
    def _ndfl_ready_user_summary(declaration: Any) -> str:
        ...
        return "\n".join(
            [
                ...
                f"- {extracted}",
                f"- {calculated}",
                "- Подтверждено вами: статус резидента и его основание, реквизиты "
                "декларации и подписанта, а также отсутствие иных доходов, расходов, "
                "вычетов, зачётов и переносимых убытков в пределах этого кейса.",
