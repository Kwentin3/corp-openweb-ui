...
Он повторно использует восстановленные Gemini/OpenAI adapters и canonical-table
contract, сохраняет provider disagreement и не публикует canonical table без
отдельного детерминированного source-to-table accounting.
