...
| Managed Financial Domain semantic asset family | Gate 2 semantic assets | Versioned Financial Semantic Pack, managed Skill/Prompt/Tool identities and future decision-reason catalog composition | Repository-managed target, non-active; Workspace surface selected for guarded authoring/inspection, but isolated safe draft and full family publish/rollback are explicit gaps | Existing V6 packet/context projection and future extension of the atomic release contour | Existing family selected as sole reuse path by Managed Semantic Decision Context GOAL 0; no second registry or GUI |
