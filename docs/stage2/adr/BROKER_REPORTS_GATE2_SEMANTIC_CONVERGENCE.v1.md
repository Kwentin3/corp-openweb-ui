...
These decisions are accepted. PR #232 was closed without merge after its
extraction ledger and KT1 acceptance gates became green. They do not authorize
KT2, product/runtime
...
- Live parity debt was closed by KT1.5 with exact atomic release, rollback
  proof, and independent readback. The operational authority is
