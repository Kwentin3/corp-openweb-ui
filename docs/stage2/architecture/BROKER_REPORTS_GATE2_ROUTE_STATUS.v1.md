...
`VERIFIED_LIVE`, and `CONTRACT_ONLY`.
...
<!-- route_id=release_live_bundle_state;status=VERIFIED_LIVE -->
...
- **Production reachability:** repository routes and exact live bundles were
  accepted by the KT1.5 terminal release and independent readback.
- **Provider reachability:** not exercised by KT1.
- **Exact consumer:** release decision and audit report.
- **Evidence:** GOAL 18 is a dated historical audit that found drift. KT1.5
  later closed that drift with an atomic release, rollback proof, and
  independent readback at operational authority
...
- **Forbidden actions:** infer future parity from this receipt, rebuild/deploy
  bundles, or mutate Functions/prompts/valves without a new authorization.

Debt: `CLOSED_BY_KT1_5`.
...
Decision Gate 1 closed PR #232 without merge after the committed extraction
ledger, accepted ADR, preserved references, and green KT1 acceptance. The
branch is retained. This disposition does not authorize code transfer or KT2.
