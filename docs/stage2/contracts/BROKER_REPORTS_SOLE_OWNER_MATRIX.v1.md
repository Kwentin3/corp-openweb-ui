...
| `release_parity` | `scripts/live_verify_broker_reports_stage2_delivery.py` for read-only verification | committed bundles + live readback | release decision | transport success or stale release reports | `KEEP_AS_SOLE_OWNER`; KT1.5 parity is closed and later bundle changes require fresh evidence |
...
### Historical stale live Function bundles
...
- **Disposition:** `SUPERSEDED_BY_KT1_5_ATOMIC_RELEASE`.
- **Debt:** closed. The operational authority is
  `db009421b68c8b09df728239d23c217e5482d3a1`; any later product or bundle
  change requires fresh parity evidence.
