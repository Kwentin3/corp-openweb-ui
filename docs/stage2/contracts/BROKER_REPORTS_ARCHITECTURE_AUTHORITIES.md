...
| Historical Financial Domain Consumer | checked consumption of the historical Financial Domain query API | current Gate 3 type/role route, Gate 1/Gate 2 storage, source parsing or domain snapshot mutation | `Gate3FinancialDomainContextFactory.create` | Query API and superseded global gate architecture | compatibility/history only | treating the historical consumer as current Gate 3 authority |
