...
| `STALE / CONFLICTING` | any unqualified claim that current Gate 3 is unresolved or current G4.1-G4.3 is not implemented | must be treated as historical text and routed to Pipeline Gates v1 before use |
