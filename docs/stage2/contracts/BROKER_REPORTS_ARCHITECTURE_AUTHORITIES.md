...
[Gate 5 Declaration Projection v0](./BROKER_REPORTS_GATE5_DECLARATION_PROJECTION.v0.md)
when working on the inactive G5.12 proof seam or the
...
when working on the inactive G5.14 proof seam. Use the
...
| `CURRENT SUPPORTING DOC` | this map, [Gate 4 -> Gate 5 Handoff v1](./BROKER_REPORTS_GATE4_HANDOFF.v1.md), [Gate 5 Methodology Selection v0](./BROKER_REPORTS_GATE5_METHODOLOGY_SELECTION.v0.md), [Gate 5 Supplemental Fact Persistence v0](./BROKER_REPORTS_GATE5_SUPPLEMENTAL_FACT_PERSISTENCE.v0.md), [Gate 5 Combined Requirement Check v0](./BROKER_REPORTS_GATE5_COMBINED_REQUIREMENT_CHECK.v0.md), [Gate 5 Supplemental Fact Discovery v0](./BROKER_REPORTS_GATE5_SUPPLEMENTAL_FACT_DISCOVERY.v0.md), [Gate 5 Single-Input Human Loop v0](./BROKER_REPORTS_GATE5_SINGLE_INPUT_HUMAN_LOOP.v0.md), [Gate 5 Methodology Calculation v0](./BROKER_REPORTS_GATE5_METHODOLOGY_CALCULATION.v0.md), [Gate 5 Trusted Methodology Authority v0](./BROKER_REPORTS_GATE5_TRUSTED_METHODOLOGY_AUTHORITY.v0.md), [Gate 5 External Evidence Routing v0](./BROKER_REPORTS_GATE5_EXTERNAL_EVIDENCE_ROUTING.v0.md), [Gate 5 Declaration Projection v0](./BROKER_REPORTS_GATE5_DECLARATION_PROJECTION.v0.md), [Gate 5 Declaration-Driven Tax Model v0](./BROKER_REPORTS_GATE5_DECLARATION_DRIVEN_TAX_MODEL.v0.md), [Gate 5 Tax-Period Category Aggregation v0](./BROKER_REPORTS_GATE5_TAX_PERIOD_CATEGORY_AGGREGATION.v0.md), [Gate 3 Handoff v1](./BROKER_REPORTS_GATE3_HANDOFF.v1.md), [Gate 4 Financial Case Fact v1](./BROKER_REPORTS_GATE4_FINANCIAL_CASE_FACT.v1.md), [Gate 4 SQL Materialization v1](./BROKER_REPORTS_GATE4_SQL_MATERIALIZATION.v1.md), [Gate 4 Case Assembly v1](./BROKER_REPORTS_GATE4_CASE_ASSEMBLY.v1.md), Gate 2 Exit, Canonical Artifact/Reader and current Gate 3 versioned contracts | explain direct boundaries or own exact DTO/factory meaning; cannot renumber gates |
...
| Gate 5 Trusted Methodology Authority | bind each closed published methodology identity/version to one exact repository package resource/hash/schema and resolve it without caller content; the original composed G5.7 route remains available | methodology CRUD/approval/lifecycle, effective-date/residency/tax-period selection, calculation behavior, case state, mutable OpenWebUI authoring or product activation | [`Gate5TrustedMethodologyAuthorityFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_trusted_methodology.py) and composed [`Gate5TrustedMethodologyCalculationRuntimeFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_trusted_methodology.py) | [Gate 5 Trusted Methodology Authority v0](./BROKER_REPORTS_GATE5_TRUSTED_METHODOLOGY_AUTHORITY.v0.md); behavior remains owned by the consuming G5.7, G5.13 or G5.14 boundary | inactive G5.8 replay plus additive G5.13/G5.14 Tax Model versions only | caller-supplied methodology/hash/path, mutable same-version content, implicit default, direct Gate 4/supplemental/store/SQL/OpenWebUI/provider reads, new registry/DB/workflow/platform |
...
| Gate 5 Declaration Projection | validate one agent-authored repository candidate against a separate exact SHA-pinned official-source evidence pack and mechanically project five stable proof-input concepts into one 2025 Appendix 8 declaration fragment | Tax Model/Methodology meaning, calculation, official-source research at case time, full XML/PDF, persistence, managed publication, generic form/XSD engine, GUI or product activation | [`Gate5DeclarationProjectionRuntimeFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_declaration_projection.py), always loading the package evidence resource and loading or accepting one candidate before constructing the projector | [Gate 5 Declaration Projection v0](./BROKER_REPORTS_GATE5_DECLARATION_PROJECTION.v0.md) | inactive G5.12 representative Appendix 8 proof only | caller-supplied evidence, XML paths/codes in projector control flow, LLM/XSD/network/DB/Gate 4 use during projection, Tax Model stub promotion, best effort, full declaration or generic mapping framework |
| Gate 5 Declaration-Driven Tax Model | combine one trusted methodology with G5.5-resolved case money and a closed source-tagged prerequisite/context input, then produce one stable securities-disposal Tax Model and mechanically adapt its five consumer meanings to G5.12 | annual aggregation, tax base/rate/tax, Tax Case/Model persistence, production evidence acquisition, full Tax Context, declaration codes/paths, XML/PDF, generic engine/DSL or product activation | [`Gate5SecuritiesDisposalTaxModelRuntimeFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_securities_disposal_tax_model.py), composing the existing G5.8 authority, G5.5 discovery and G5.12 projector factories | [Gate 5 Declaration-Driven Tax Model v0](./BROKER_REPORTS_GATE5_DECLARATION_DRIVEN_TAX_MODEL.v0.md), G5.8, G5.5 and G5.12 | inactive G5.13 single-operation closed proof only | direct Gate 4/supplemental/store/SQL/source/provider reads, hidden defaults, related-to-allowable shortcut, float/LLM arithmetic, declaration representation in Tax Model, new DB/repository/workflow/Tax Engine |
| Gate 5 Tax-Period Category Aggregation | validate one explicit taxpayer/category/period scope and at least two complete G5.13 operation models, bind a user-verified completeness assertion to their exact deterministic member hashes, aggregate stable semantics and invoke G5.12 only for a complete scope | operation input discovery, category classification, expense allowability, tax base/rate/tax, persistence, cross-run rebinding, generic aggregation/query, full declaration or product activation | [`Gate5TaxPeriodCategoryAggregationRuntimeFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_tax_period_category_aggregation.py), composing G5.8 methodology authority and G5.12 projector; operation inputs come from the additive G5.13 `run_operation` path | [Gate 5 Tax-Period Category Aggregation v0](./BROKER_REPORTS_GATE5_TAX_PERIOD_CATEGORY_AGGREGATION.v0.md), G5.13 and G5.12 | inactive G5.14 two-operation proof only | treating Gate 4 technical completeness as tax completeness, raw-fact aggregation, stale completeness after member change, mixed category/period/currency/loss, direct upstream/storage reads, LLM, DB, Tax Case or generic engine |
...
| Gate 5 validated declaration-fragment projection | [`Gate5DeclarationProjectionRuntimeFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_declaration_projection.py), validating the candidate spec against the captured official-source evidence pack once, then returning a projector that interprets only the closed spec and proof input | [Gate 5 Declaration Projection v0](./BROKER_REPORTS_GATE5_DECLARATION_PROJECTION.v0.md) and [G5.10 declaration-backwards research](../../reports/2026-08-09/BROKER_REPORTS_GATE5_DECLARATION_BACKWARDS_TAX_MODEL_G5_10.report.md) | inactive G5.12 Appendix 8 proof | exact five mappings are evidence-bound; replay is deterministic; unknown concept, missing/conflicting mapping, invalid target/code or incomplete evidence fail closed; result says structurally consistent, not full-XSD-valid | case-time LLM/research/XSD parse, target literals in executor, Tax Methodology calculation, production Tax Model, full XML/PDF, persistence/publication, generic form engine, GUI or product route |
...
| Gate 5 tax-period/category scope and aggregation | [`Gate5TaxPeriodCategoryAggregationRuntimeFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate5_tax_period_category_aggregation.py), validating operation-model methodology through G5.8 and delegating complete category semantics to G5.12; G5.13 `run_operation` creates each member without category-completeness meaning | [Gate 5 Tax-Period Category Aggregation v0](./BROKER_REPORTS_GATE5_TAX_PERIOD_CATEGORY_AGGREGATION.v0.md), G5.13 and G5.12 | inactive G5.14 two-operation proof | exact scope and sorted member-model hashes produce a deterministic binding; absent evidence returns known totals with `incomplete_scope`; a user-verified assertion bound to that hash admits one category model and projection; aggregate provenance retains operation values and source evidence | raw Gate 4 aggregation, technical-to-tax completeness promotion, category/allowability/loss decisions in aggregator, stale assertion reuse, cross-run Supplemental rebinding, persistence, generic aggregation framework or product route |
