...
| `CURRENT SUPPORTING DOC` | this map, [Gate 3 Handoff v1](./BROKER_REPORTS_GATE3_HANDOFF.v1.md), Gate 2 Exit, Canonical Artifact/Reader and current Gate 3 versioned contracts | explain direct boundaries or own exact DTO/factory meaning; cannot renumber gates |
...
| Financial Domain | immutable historical snapshot, bounded query semantics and serialization envelope | current Gate 3 label-only meaning, raw source/provider reads or workflow state | catalog, query and persistence factories | Managed Financial Domain and Query API | historical compatibility consumer and future storage adapter | direct record catalogs, query facades or snapshot minting |
| Gate 3 Minimal Labeling Contract | DTO meaning for one canonical-bound projection, sparse label proposal and validated annotation sidecar; exact G3.2 traversal/alias rule and its bare-alias model-facing schema projection | financial dictionary meaning, provider execution, persistence, workflow or activation | [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md) and its four closed schemas | current Gate 3 contracts | G3.2 projection and separately authorized G3.3-G3.6 implementations | a second target grammar, alias parser/normalizer, rewritten canonical artifact or Financial Domain on the current Gate 3 route |
...
| Gate 3 Bounded Labeling | exact three-part model context, contract-projected bare-alias description, one provider proposal, closed response validation and backend-only alias restoration | deterministic semantic classification, alias normalization, retry/repair/fallback, persistence, workflow, batching or activation | [`Gate3BoundedLabelingFactory.create/create_from_chunk`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate3_bounded_labeling.py) using the existing `Gate2StructuredModelClientFactory.create` provider path | [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md), [Financial Label Dictionary v1](./BROKER_REPORTS_GATE3_FINANCIAL_LABEL_DICTIONARY.v1.md) and [Gate 3 Handoff v1](./BROKER_REPORTS_GATE3_HANDOFF.v1.md) | NDFL product workflow plus retained proofs and human review | second prompt/dictionary/projection/validator/alias grammar, model-provided canonical refs, code-owned financial classifier or annotation storage |
| Gate 3 Chunk Batch Labeling | sequential one-attempt execution of preselected G3.4B chunks and deterministic in-memory merge of existing validated annotations | chunk boundaries, financial meaning, dictionary/instruction wording, provider adaptation, retry/repair, persistence, workflow or activation | [`Gate3ChunkBatchLabelingFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate3_chunk_batch_labeling.py) calling `Gate3StructuralChunkFactory.create` and `Gate3BoundedLabelingFactory.create_from_chunk` | [Chunk Batch Labeling v1](./BROKER_REPORTS_GATE3_CHUNK_BATCH_LABELING.v1.md), [Structural Chunking v1](./BROKER_REPORTS_GATE3_STRUCTURAL_CHUNKING.v1.md) and [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md) | NDFL product workflow plus retained proofs and human review | second provider/validator/classifier, semantic deduplication, concurrency/retry infrastructure, persistence or product route |
| Gate 3 FinancialAnnotations Persistence | admission of a complete validated document result, exact active canonical/dictionary/instruction/model/provider binding, and immutable private sidecar save/read | labeling, canonical mutation, physical storage, retention/purge policy, workflow or activation | [`Gate3FinancialAnnotationsPersistenceFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate3_financial_annotations_persistence.py) delegating to `ArtifactStore` and `ArtifactResolver` | [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md), [`FinancialAnnotationsV1`](./BROKER_REPORTS_FINANCIAL_ANNOTATIONS.v1.schema.json) and the existing Artifact Lifecycle contract | NDFL product workflow and artifact-derived G3.6 readiness | incomplete sidecar publication, second database/store/resolver, mutable overwrite, copied financial meaning, Gate 2 mutation or workflow state |
...
| Historical Financial Domain Consumer | checked consumption of the historical Financial Domain query API | current Gate 3 label-only route, Gate 1/Gate 2 storage, source parsing or domain snapshot mutation | `Gate3FinancialDomainContextFactory.create` | Query API and superseded global gate architecture | compatibility/history only | treating the historical consumer as current Gate 3 authority |
...
Gates v1, product/task-specific LLM-friendly projection and sparse financial
labeling belong to the current Gate 3 contour. G3.1 defines its DTO boundary;
G3.2 implements the reader-backed projection, G3.3M the managed dictionary,
and G3.4 their one-attempt-per-chunk labeling composition. G3.C5 activates
these owners only inside the stable NDFL product route. DOC33's neutral reader-only renderer remains completeness proof
...
| Gate 3 minimal labeling DTO meaning | [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md) plus shared [`Gate3CanonicalTargetV1`](./BROKER_REPORTS_GATE3_TARGET.v1.schema.json), [`Gate3ProjectionV1`](./BROKER_REPORTS_GATE3_PROJECTION.v1.schema.json), [`Gate3LabelingResponseV1`](./BROKER_REPORTS_GATE3_LABELING_RESPONSE.v1.schema.json) and [`FinancialAnnotationsV1`](./BROKER_REPORTS_FINANCIAL_ANNOTATIONS.v1.schema.json) schemas | [Pipeline Gates v1](./BROKER_REPORTS_PIPELINE_GATES.v1.md) and [Gate 3 Handoff v1](./BROKER_REPORTS_GATE3_HANDOFF.v1.md) | G3.2 projection and separately authorized G3.3-G3.6 implementations | G3.1 contract remains current; G3.2 implements only its projection portion | a second locator grammar, exhaustive outcome taxonomy, model-provided canonical refs, rewritten canonical source or Financial Domain on the label-only route |
...
| Gate 3 chunk batch labeling and merge | [`Gate3ChunkBatchLabelingFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate3_chunk_batch_labeling.py) over exact G3.4B chunks and [`Gate3BoundedLabelingFactory.create_from_chunk`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate3_bounded_labeling.py) | [Chunk Batch Labeling v1](./BROKER_REPORTS_GATE3_CHUNK_BATCH_LABELING.v1.md), [Structural Chunking v1](./BROKER_REPORTS_GATE3_STRUCTURAL_CHUNKING.v1.md), [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md) | NDFL product workflow plus retained G3.4C proofs | a selected subset is never called a complete document; any selected rejection/failure makes the result incomplete; merge only restores validated annotations in canonical order | changed chunk/dictionary/instruction baseline, direct provider call, retry/repair/fallback, semantic merge/dedup, concurrent job system, persistence outside its owner or another product route |
| Gate 3 FinancialAnnotations sidecar save/read | [`Gate3FinancialAnnotationsPersistenceFactory.create`](../../../services/broker-reports-gate1-proof/broker_reports_gate1/gate3_financial_annotations_persistence.py), delegating record writes to the injected ArtifactStore and reads/access to `ArtifactResolver` | [Minimal Labeling v1](./BROKER_REPORTS_GATE3_MINIMAL_LABELING.v1.md), [`FinancialAnnotationsV1`](./BROKER_REPORTS_FINANCIAL_ANNOTATIONS.v1.schema.json) and [Artifact Lifecycle](./BROKER_REPORTS_ARTIFACT_LIFECYCLE_CONTRACT.v0.md) | NDFL product workflow, retained G3.5 proof and artifact-derived G3.6 readiness | only a complete all-chunk result is admitted; targets are checked against the current structural projection; provider stays immutable envelope metadata; canonical payload and pointer remain unchanged | direct SQLite/files, new DB, unvalidated/partial write, active-version mismatch, alias persistence, semantic repair or workflow/product activation outside NDFL |
...
- `gate3_context_manifest.py` is the legacy bounded Gate 2 handoff root;
  ...
  successor consumer. Neither is the current Gate 3 label-only authority. The
